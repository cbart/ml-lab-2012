...
discrete_kernel = function(x, y, n)
  as.integer(sum(x - y)^2 < n)
...
#do.kernel.test2(ex5,0,6,discrete_kernel,0.06)

#zad1=data.frame(a1=c(1, 2, 3, 100, 101, 102), d=c(10, -10, 10, 10, -10, 10))
#do.kernel.test2(zad1,0,103,gaussian.kernel,18)
...
do.reg.kernel.test(ex5,0,6,discrete_kernel,0.1,0.05)
